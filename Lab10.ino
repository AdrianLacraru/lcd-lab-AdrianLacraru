...
void reactionGame() {
  ...
  lcd.print("Ready up!"); // Inform the player to get ready
  ...
  delay(random(0, 6000));    // !!! ENTER THE CODE HERE !!!

  lcd.clear();                 
  lcd.print("PRESS!!");  // Ask the player to press the button as fast as possible
